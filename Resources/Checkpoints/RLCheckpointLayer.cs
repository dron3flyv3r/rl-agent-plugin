...
///   <item><term>lstm</term><description><see cref="HiddenSize"/> and <see cref="GradClipNorm"/></description></item>
///   <item><term>gru</term><description><see cref="HiddenSize"/> and <see cref="GradClipNorm"/></description></item>
...
{
    /// <summary>Layer type: "dense", "dropout", "lstm", "gru", "layer_norm", or "flatten".</summary>
    ...
    /// <summary>Hidden size for recurrent layers only.</summary>
    public int HiddenSize { get; set; }

    /// <summary>Per-layer gradient clip norm for recurrent layers only.</summary>
