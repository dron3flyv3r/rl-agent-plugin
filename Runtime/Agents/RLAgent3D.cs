...
public partial class RLAgent3D : Node3D, IRLAgent
{
    ...
    private RLAcademy? ResolveAcademy()
    {
        ...
        // Fallback: scene-wide group search (handles sibling academy, e.g. Academy and Arena
        // both being direct children of the scene root rather than Academy being a parent).
        if (IsInsideTree())
        {
